...
// let arr1 = [1, 2, 3];
// let duped1 = deepDup(arr1); // [1, 2, 3]
// console.log(duped1);
// console.log(arr1 === duped1);

let arr2 = [1, [2, [3]]];
let duped2 = deepDup(arr2); // [1, [2, [3]]]
console.log(duped2);
console.log(arr2 === duped2); // false
console.log(arr2[1] === duped2[1]); // false
console.log(arr2[1][1] === duped2[1][1]); // false
