...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  // call bakePies() to bake the specified number of pies
  bakePies(pieType, pieQuantity, recipe);

  // calculate the cost of a single pie
  const singlePieCost = calcPieCost(recipe);

  // Calculate the total cost of all the pies
  const totalCost = singlePieCost * pieQuantity;
