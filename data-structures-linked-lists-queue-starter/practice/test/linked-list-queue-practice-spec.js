...
describe('Part 2: Linked Lists', () => {
  ...
  it('`findNthNode` finds a node in the linked list', () => {
    ...
    expect(list.findNthNode(3)).to.equal(14);
  });
  ...
  it('`findMid` returns the middle node (rounded down)', () => {
    ...
    expect(list.findMid()).to.equal(2);

    list.addToTail(4);
    list.addToTail(5);
    list.addToTail(6);

    expect(list.findMid()).to.equal(3);
  });


  it('`reverse` returns a new reversed linked list', () => {

    list.addToTail(1);  // node
    list.addToTail(2);  // previous
    list.addToTail(3);
    list.addToTail(4);
    list.addToTail(5);
    list.addToTail(6);
  ...
  it('`reverseInPlace` reverses the linked list in-place', () => {
    ...
    list.addToTail(1);  // p2 (2)
    list.addToTail(2);  // temp / p2 (1)
    list.addToTail(3);
    list.addToTail(4);
    list.addToTail(5);
    list.addToTail(6);
...
describe('Part 3: Doubly Linked Lists', () => {
  ...
  it('`findMid` returns the middle node (rounded down)', () => {
    ...
    dll.addToTail(2);
    dll.addToTail(3);
    expect(dll.findMid()).to.equal(2);

    dll.addToTail(4);
    dll.addToTail(5);
    dll.addToTail(6);
    expect(dll.findMid()).to.equal(3);
  });
